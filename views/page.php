<div style="margin-top: 15px;margin-left: 30px;width: 240px; border: 1px solid #777777; float: left">
    ...
    //adwit_head_top($adwit_ads, $adwit_ban_list, 'page')
    ?>
    ...
    adwit_content_top($adwit_ads, $adwit_ban_list, 'page')
    ?>
    <?php
    include(ADWIT_BANNER_MANAGER_PATH . '/views/_content_middle.php');
    adwit_content_middle($adwit_ads, $adwit_ban_list, 'page')
    ?>
<?php
    include(ADWIT_BANNER_MANAGER_PATH . '/views/_content_bottom.php');
    adwit_content_bottom($adwit_ads, $adwit_ban_list, 'page')
?>
</div>